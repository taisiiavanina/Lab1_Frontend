...
console.log(`Товар з неповними даними додано в кінець. Всього: ${products2.length}`);
...
console.log(`Товар з повними даними додано на початок. Всього: ${products2.length}`);
...
console.log("Користувачі за листопадом (близько 10:00):");
...
console.log(`Середній вік: ${averageAge} років`);
